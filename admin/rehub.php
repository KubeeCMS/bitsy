...
function rh_standard_wp_pages_styles() { ?>
	<?php $logoimage = rehub_option('rehub_logo'); $bg = rehub_option('rehub_header_color_background')?>
    <style type="text/css">
    	...
    	<?php endif;?>
    	body.login.wp-core-ui .button-group.button-large .button, body.login.wp-core-ui .button.button-large{padding:4px; font-size:18px; width:100%;}
    </style>
<?php }
